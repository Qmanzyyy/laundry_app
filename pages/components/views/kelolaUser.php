    ...
    <?php foreach ($users as $user) : ?>
        <div class="bg-white p-4 rounded-lg shadow-md">
            ...
            <p class="text-gray-600 text-sm">
                Role: <span class="px-3 py-1 rounded-full text-white text-xs font-semibold 
    ...
    <div class="bg-white p-6 rounded-lg shadow-lg max-w-lg w-full">
        ...
        <form id="editForm" action="" method="POST">
            ...
            <div class="hidden">
                ...
                <input type="hidden" name="username" id="edit_username" required class="w-full px-4 py-2 border rounded-lg">
            </div>
            ...
            <div class="flex justify-end gap-4">
                ...
                <button type="submit" name="update" class="bg-blue-500 text-white px-4 py-2 rounded-lg">
                    Simpan Perubahan
                </button>
            </div>
        </form>
