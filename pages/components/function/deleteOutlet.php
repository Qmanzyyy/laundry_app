...
try {
    ...
    $sql1 = "DELETE FROM tb_outlet WHERE id = $id";
    ...
    if (!$conn->query($sql1)) {
        ...
        error_log("Eksekusi gagal : " . $conn->error);
    ...
    echo "Success: Data Outlet berhasil dihapus."; // Menampilkan pesan sukses
    ...
    error_log("deleteOutlet.php: Exception ditangkap: " . $e->getMessage());
